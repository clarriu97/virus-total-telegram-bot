...
dialogs = {
    "help": {
        ENGLISH:
            ...
            "URL or a file (up to %s megabytes) and I will give you the results of the analysis. 😊",
        SPANISH:
            ...
            "y URLs. Puedes enviarme una URL o un archivo (hasta %s megabytes) y te daré los "
